from algorithm_agent_8 import RepeatedForwardAStar, AStar
...
if __name__ == '__main__':
    ...
    save_file_path=os.path.join(current_path, "agent_8")
    if not os.path.exists(save_file_path):
        os.mkdir(save_file_path)
    file_dir=os.path.join(save_file_path, "agent_8.json")
